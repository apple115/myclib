...
static void employee_travel(struct list_head* head)
{
    struct employee* pos;
...
static void employee_travel_reverse(struct list_head* head)
{
    struct employee* pos;
...
static void employee_del_all(struct list_head* head)
{
    struct employee* pos;
